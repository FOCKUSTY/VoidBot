const
    ...
    { setChannel, setBool, setVersionUpdate } = require('../../events/modals'),
...
module.exports =
{
    ...
    async execute(int)
    {
        ...
        const modal = new ModalBuilder().setCustomId(`updateModal`).setTitle(`Ваше обновление !`);

        let ideaDetailPH = objectIdeas[pseudoRandomNumber(0, objectIdeas.length-1, 1, 1, null, null, null, false, true, true)]['ideaDetail']
